...
<!--fichier servant de référence pour piocher les éléments-->
<!DOCTYPE html>
        ...
        <header class="header">
            <div class="en-tete">
                <a href="{{ route('annuaire') }}"><img class="logo"
                        ...
                        alt="écusson"></a><!--renvoi à la page index.html-->
                    ...
                    <form class="space-y-6" action="#" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <label for="remember" class="ml-3 block text-sm leading-6 text-gray-900">Remember
                                    me</label>
                            </div>
                        </div>
